  ...
  return (
    <div className={cn("relative p-[4px] group", containerClassName)}>
      <motion.div
        ...
        className={cn(
          "absolute inset-0 rounded-3xl z-[1] opacity-40 group-hover:opacity-70 blur-lg transition duration-500 will-change-transform",
      ...
      <div className={cn("relative z-10 bg-white rounded-3xl", className)}>{children}</div>
    </div>
  );
};