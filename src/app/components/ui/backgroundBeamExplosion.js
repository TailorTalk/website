...
export const BackgroundBeamsWithCollision = ({
  ...
  return (
    <div
      ref={parentRef}
      style={{
        background: "repeating-linear-gradient(45deg, rgb(240, 241, 244), rgb(240, 241, 244) 1px, transparent 1px, transparent 4px)"
      }}
      className={cn(
        "h-96 md:h-full bg-white pb-10 relative flex flex-col items-center w-full justify-center overflow-hidden",
